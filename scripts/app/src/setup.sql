...
GRANT USAGE, CREATE PROCEDURE ON SCHEMA METADATA TO APPLICATION ROLE app_user;

GRANT USAGE, CREATE PROCEDURE ON SCHEMA METADATA TO APPLICATION ROLE app_admin;
...
END;
GRANT USAGE ON PROCEDURE LLM.GET_CHAT_COMPLETE(varchar, varchar) TO APPLICATION ROLE app_admin;
GRANT USAGE ON PROCEDURE LLM.GET_CHAT_COMPLETE(varchar, varchar) TO APPLICATION ROLE app_user;
