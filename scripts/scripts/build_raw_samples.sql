...
select  *, value:value.string_value as QUERY_PARAMETERS_UTMS, SPLIT_PART(SPLIT_PART(QUERY_PARAMETERS_UTMS, 'utm_source=', 2),'&',0) as UTM_SOURCE,
               ...
               SPLIT_PART(SPLIT_PART(QUERY_PARAMETERS_UTMS, '%d_id%=', 2),'&',0) as utm_ad_id from C360_SAMPLE.CUSTOMER72_GA_LAT_LONG_VW,  LATERAL FLATTEN( INPUT => PARSE_JSON(EVENT_PARAMS_UTMS) );
